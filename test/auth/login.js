...
var green = "\x1b[32m";
var base = "auth";
function testNoAuth(requester, usuario, mensaje) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, requester.post("".concat(base, "/login"), usuario)];
                case 1:
                    respuesta = _a.sent();
...
exports.testNoAuth = testNoAuth;
function testAuth(requester, usuario) {
    return __awaiter(this, void 0, void 0, function () {
